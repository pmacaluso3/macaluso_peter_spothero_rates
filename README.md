Run using Ruby v1.9.3 or later. From the command line, cd into this directory and run "bundle install". To be extra safe, run "gem install rspec" and "gem install json". 
